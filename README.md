...
| # | Группа | Статус | Подзадачи |
|---|--------|--------|-----------|
| 1 | Каркас проекта и базовая инфраструктура | ✅ Готово | 1.1 ✅ · 1.2 ✅ · 1.3 ✅ · 1.4 ✅ · 1.5 ✅ · 1.6 ✅ |
...
| 19 | Тестирование (PHPUnit + Eris) | 🟡 в процессе | 1.5 ✅ (Property 13) |
| 21 | Сидеры и демо-данные | ⚪ | — |

**Готово:** 7/114 задач (6 %). Все unit/property тесты проходят: `php artisan test` → **52 passed, 1685 assertions**.
